...
// -chnaged to below- Annotationeer.pdfDocumentInfo.documentId = '1000';
// ahmad
// -----START-----
Annotationeer.pdfDocumentInfo.documentId = 'getSignatures.php';
// -----END-----
...
Annotationeer.saveDigitalSignature = function(signaturePad, justUse, annotation) {
    ...
    if (ds){
        if(parent.SUGAR){
            ds.sugar_user_id = parent.SUGAR.App.user.get('id');
        } else{
            ds.sugar_user_id = sugar_user_id;
        }
    }
    // -----END-----
...
Annotationeer.deleteDigitalSignature = function(id) {
    $.ajax({
        // -chnaged to below- url: Url.restUrl + Url.signatureDeleteUrl + '/' + id,
        // ahmad
        // -----START-----
        url: Url.restUrl + Url.signatureDeleteUrl + '?signature_id=' + id,
        // -----END-----
        type: 'delete',
        headers: {
            'username': Annotationeer.getUsername()
