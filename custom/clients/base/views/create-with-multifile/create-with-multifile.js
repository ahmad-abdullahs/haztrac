({
    ...
    saveAttachments: function (model, parent_id) {
        var url = '';
        if (this.module == 'LR_Lab_Reports') {
            url = 'LR_Lab_Reports/' + parent_id + '/link/lr_lab_reports_mv_attachments';
        } else if (this.module == 'HT_Manifest') {
            url = 'HT_Manifest/' + parent_id + '/link/ht_manifest_mv_attachments';
        }
