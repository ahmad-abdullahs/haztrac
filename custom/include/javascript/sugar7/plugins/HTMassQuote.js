        ...
        app.plugins.register('MassQuote', ['view'], {
            ...
            massQuote: function() {
                ...
                var invalidItems = massQuote.filter(function(model) {
                    ...
                    if (_.isEmpty(model.get('ht_sales_service_catalog_id')) && !_.isEmpty(model.get('category_id'))) {
                ...
                if (massQuote) {
                    ...
                    _.each(massQuote.models, function(rliModel) {
                        ...
                        qliModels.push(app.data.createBean('HT_Sales_Service_Products', rliObj));
                    }, this);
                    ...
                    // Load the HT_SS_Quotes create view
