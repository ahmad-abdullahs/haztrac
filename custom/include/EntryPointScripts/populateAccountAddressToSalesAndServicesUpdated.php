...
// http://localhost/haztrac/#bwc/index.php?entryPoint=populateAccountAddressToSalesAndServicesUpdated

if (!defined('sugarEntry') || !sugarEntry)
    die('Not A Valid Entry Point');

class populateAccountAddressToSalesAndServicesUpdated {
...
$init = new populateAccountAddressToSalesAndServicesUpdated();
$init->execute();
echo '<br>';
