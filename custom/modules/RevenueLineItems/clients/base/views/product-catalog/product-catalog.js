...
({
    ...
    _getSpriteSheets: function () {
        return [{
                id: 'prodCatTS',
                imagePath: 'custom/modules/RevenueLineItems/clients/base/views/product-catalog/product-catalog-ss.png',
                dataPath: 'custom/modules/RevenueLineItems/clients/base/views/product-catalog/product-catalog-ss.json'
            }];
    },
