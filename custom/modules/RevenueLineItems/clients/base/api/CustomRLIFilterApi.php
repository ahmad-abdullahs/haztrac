...
class CustomRLIFilterApi extends FilterApi {
    ...
    public function registerApiRest() {
        return array_merge(parent::registerApiRest(), array(
            ...
            'filterModuleAllCount' => array(
                'reqType' => 'GET',
                'path' => array('RevenueLineItems', 'count'),
                'pathVars' => array('module', ''),
                'jsonParams' => array('filter'),
            ...
            'filterModulePostCount' => array(
                'reqType' => 'POST',
                'path' => array('RevenueLineItems', 'filter', 'count'),
                'pathVars' => array('module', '', ''),
    ...
    public function addStandaloneProductsFilter($args) {
        ...
        // we need all RevenueLineItems on default list view except for the child ones.
