...
require_once 'modules/Opportunities/clients/base/api/RecentProductApi.php';

class CustomRecentProductApi extends RecentProductApi {
    ...
    public function getRecentRecords(ServiceBase $api, array $args) {
        ...
        try {
            ...
            $mostRecentQuery->where()
                    ...
                    ->notIn('is_bundle_product_c', array('child'));
