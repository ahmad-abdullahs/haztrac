...
class CustomOpportunitiesRelateApi extends RelateApi {

    public function registerApiRest() {
        return array_merge(parent::registerApiRest(), array(
            'listRelatedRecords' => array(
                'reqType' => 'GET',
                'path' => array('Opportunities', '?', 'link', 'revenuelineitems'),
            ...
            'listRelatedRecordsCount' => array(
                'reqType' => 'GET',
                'path' => array('Opportunities', '?', 'link', 'revenuelineitems', 'count'),
                'pathVars' => array('module', 'record', '', 'link_name', ''),
                'jsonParams' => array('filter'),
            ...
            'listRelatedRecordsLeanCount' => array(
                'reqType' => 'GET',
                'minVersion' => '11.4',
                'path' => array('Opportunities', '?', 'link', 'revenuelineitems', 'leancount'),
                'pathVars' => array('module', 'record', '', 'link_name', ''),
                'jsonParams' => array('filter'),
