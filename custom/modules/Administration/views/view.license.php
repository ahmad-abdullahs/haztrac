...
class AdministrationViewLicense extends SugarView
{
    ...
    public function display()
    {
        ...
        require_once('custom/login_slider/license/config.php');
        ...
        $this->ss->display('custom/login_slider/license/tpls/license.tpl');
    }
    ...
    protected static function loadLicenseStrings()
    {
        ...
        foreach ( $langs as $lang ) {
            ...
            if(!@include("custom/login_slider/license/language/$lang.lang.php")) {
