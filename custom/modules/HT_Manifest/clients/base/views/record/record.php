                            ...
                            array(
                                ...
                                'fields' => array(
                                    array(
                                        ...
                                        'css_class' => 'transporter_name',
                                        'label' => 'LBL_TRANSPORTER',
                                        'rname' => 'name',
                                        'type' => 'relate',
                                        'id_name' => 'transporter_name_id',
                                        'module' => 'Accounts',
                                        'link' => true,
                                        'span' => 5,
                                        'default' => true,
                                        ...
                                        'filter_populate' => array(
                                            'tag' => array('Transporter'),
                                        ),
                                    ),
                                    array(
                                        'name' => 'transporter_transfer_date',
                                        'css_class' => 'transporter_transfer_date',
                                        'label' => 'LBL_TRANSPORTER_TRANSFER_DATE',
                                        'type' => 'date',
                                        'span' => 5,
                                        'default' => true,
                                    ),
                                    array(
                                        'name' => 'transporter_line_number',
                                        'css_class' => 'transporter_line_number',
                                        'type' => 'text',
                                        'default' => false,
                                    ),
                                )
