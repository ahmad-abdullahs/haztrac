...
$dependencies['WPM_Waste_Profile_Module']['neshap_rules_c_readonly_setvalue_dep'] = array(
    'hooks' => array("all"),
    'trigger' => 'true',
    ...
    'actions' => array(
        ...
        array(
            ...
            'params' => array(
                ...
                'value' => 'ifElse(equal($quest_is_usepa_hazardous_c,"Yes"),$notes_tab_quantity_c,"")',
            ),
        ),
        array(
            'name' => 'SetValue',
            'params' => array(
                ...
                'value' => 'ifElse(equal($quest_is_usepa_hazardous_c,"Yes"),$notes_describe_knowledge_c,"")',
            ),
        ),
//        array(
//            'name' => 'SetRequired',
