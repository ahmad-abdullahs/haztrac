                                            ...
                                            <ul class="try-editor-list clearFix">
                                                <li>
                                                    <!--
                                                        // Ahmad
                                                    -->
                                                    <a class="try-editor word reload-page" target="_blank" href="doceditor.php?fileExt=docx&userFileName=docTemplate-101.docx&user=<?php echo htmlentities($user); ?>">Document</a>
                                                </li>
                                                <li>
