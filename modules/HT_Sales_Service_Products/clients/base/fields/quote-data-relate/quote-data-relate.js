 ...
 */
/**
 * @class View.Fields.Base.HT_Sales_Service_Products.QuoteDataRelateField
...
({
    ...
    initialize: function(options) {
        this.createNewLabel = app.lang.get('LBL_CREATE_NEW_QLI_IN_DROPDOWN', 'HT_Sales_Service_Products');
    ...
    /**
     * Overriding because getSearchModule needs to return HT_Sales_Service_Products for this metadata
     *
     * @inheritdoc
     */
    _getPopulateMetadata: function() {
        return app.metadata.getModule('HT_Sales_Service_Products');
    },

    /**
     * Overridden select2 change handler for the custom case of being able to add new unlinked HT_Sales_Service_Products
     * @param evt
     * @private
     */
    _onSelect2Change: function(evt) {
        ...
        if (id === this.newQLIId) {
            ...
            this.model.set({
                ht_sales_service_catalog_id: '',
                ht_sales_service_catalog_name: value,
                name: value
            });
    ...
    /**
     * Extending to also check models' ht_sales_service_catalog_name/name and ht_sales_service_catalog_id/id
     *
     * @inheritdoc
     */
    ...
    /**
     * Overriding if there's no ht_sales_service_catalog_id or name, use the HT_Sales_Service_Products module and record ID
     *
     * @inheritdoc
     */
