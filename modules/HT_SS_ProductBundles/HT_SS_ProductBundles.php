 ...
 */
require_once('modules/HT_SS_ProductBundles/HT_SS_ProductBundles_sugar.php');
class HT_SS_ProductBundles extends HT_SS_ProductBundles_sugar {
    ...
    public $rel_quotes = "ht_product_bundle_quote";
    public $rel_products = "ht_product_bundle_product";
    public $rel_notes = "ht_product_bundle_note";
    ...
    public function mark_deleted($id)
    {
        ...
        $this->load_relationship('ht_product_bundle_notes');
        $lineItems = $this->ht_product_bundle_notes->getBeans();
    ...
    /**
     * Return any associated ht_ss_quotes to this HT_SS_ProductBundles
     * @return array
     */
    public function getQuotes()
    {
        $this->load_relationship('ht_ss_quotes');

        return $this->ht_ss_quotes->getBeans();
    }
    ...
    {
        $this->load_relationship('ht_product_bundle_notes');
        $beans = $this->ht_product_bundle_notes->getBeans();
    ...
    /**
     * Get all the line items for a HT_SS_ProductBundles in the order they are set.
     *
     * @return array
     */
    public function getLineItems()
    {
        ...
        $bundle_list = array_merge(
            ...
            $this->ht_product_bundle_notes->getBeans()
        );
...
//		global $support_expired, $support_coming_due, $support_coming_due_color, $support_expired_color;
        ...
        include('modules/HT_Sales_Service_Products/config.php');
    ...
    public function updateCurrencyBaseRate()
    {
        ...
        // get the beans
        $beans = $this->ht_ss_quotes->getBeans();
