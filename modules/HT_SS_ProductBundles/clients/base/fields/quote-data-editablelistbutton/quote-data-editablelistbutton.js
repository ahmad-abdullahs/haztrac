 ...
 */
/**
 * @class View.Fields.Base.HT_SS_ProductBundles.EditablelistbuttonField
...
({
    ...
    cancelClicked: function() {
        var syncedAttribs = this.model.getSynced();
        var itemsInGroup = this.model.get('ht_product_bundle_items');
    ...
    _saveRowModel: function() {
        ...
        app.api.relationships('update', 'HT_SS_Quotes', {
