 ...
 */
/**
 * @class View.Views.Base.HT_SS_ProductBundles.QuoteDataGroupHeaderView
...
({
    ...
    initialize: function(options) {
        ...
        this.groupSaveCt = 0;
        this.layout.on('ht_ss_quotes:group:save:start', this._onGroupSaveStart, this);
        this.layout.on('ht_ss_quotes:group:save:stop', this._onGroupSaveStop, this);
    ...
    _onCreateQLIBtnClicked: function(evt) {
        this.layout.trigger('ht_ss_quotes:group:create:qli', 'products');
    },
    ...
    _onCreateCommentBtnClicked: function(evt) {
        this.layout.trigger('ht_ss_quotes:group:create:note', 'ht_product_bundle_notes');
    },
    ...
    _onDeleteBundleBtnClicked: function(evt) {
        this.context.parent.trigger('ht_ss_quotes:group:delete', this.layout);
    },
