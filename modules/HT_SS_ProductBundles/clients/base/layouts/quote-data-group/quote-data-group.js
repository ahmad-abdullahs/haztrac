 ...
 */
/**
 * @class View.Layouts.Base.HT_SS_ProductBundles.QuoteDataGroupLayout
...
({
    ...
    /**
     * This is the HT_SS_ProductBundles ID from the model set here on the component
     ...
     * @type View.Views.Base.HT_SS_ProductBundles.QuoteDataGroupListView
     */
    ...
    initialize: function(options) {
        ...
        // set this collection to the ht_product_bundle_items collection
        this.collection = this.model.get('ht_product_bundle_items');
        ...
        var listMeta = app.metadata.getView('HT_Sales_Service_Products', 'quote-data-group-list');
    ...
    bindDataChange: function() {
        this.model.on('change:ht_product_bundle_items', this.render, this);
