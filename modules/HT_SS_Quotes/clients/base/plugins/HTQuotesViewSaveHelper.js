...
(function(app) {
    app.events.on('app:init', function() {
        ...
        /**
         * HTQuotesViewSaveHelper is a helper function for multiple HT_SS_Quotes views.
         */
        app.plugins.register('HTQuotesViewSaveHelper', ['view'], {
            ...
            hasUnsavedQuoteChanges: function() {
                ...
                if (hasUnsavedChanges) {
                    // get the HT_SS_Quotes bean defaults
            ...
            /**
             * Checks the Quote's HT_SS_ProductBundles and items for changes
             *
             * @return {boolean}
             */
            hasUnsavedBundleChanges: function() {
                ...
                changedBundle = bundles.find(function(bundle) {
                    ...
                    keysToOmit = ['ht_product_bundle_items', '_justSaved'].concat(bundleCalculatedFields);
                    ...
                    if (bundleChanged === false && bundle.has('ht_product_bundle_items')) {
                        // the bundle hasn't changed, so check the items on it
                        items = bundle.get('ht_product_bundle_items');
