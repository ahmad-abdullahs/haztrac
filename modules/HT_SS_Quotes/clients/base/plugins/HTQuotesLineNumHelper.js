...
(function(app) {
    app.events.on('app:init', function() {
         ...
         */
        app.plugins.register('HTQuotesLineNumHelper', ['view'], {
            /**
            ...
            onAttach: function(component, plugin) {
                this.once('init', function() {
                    ...
                    if (this.model.module === 'HT_SS_Quotes') {
                        ctx = this.context;
                    } else {
                        ctx = this.context.parent;
                        this.layout.on('ht_ss_quotes:line_nums:reset', this.resetGroupLineNumbers, this);
                    }

                    ctx.on('ht_ss_quotes:show_line_nums:changed', this.onShowLineNumsChanged, this);
            ...
            onDetach: function(component, plugin) {
                ...
                if (this.model.module === 'HT_SS_Quotes') {
                    ...
                    ctx = this.context.parent;
                    this.layout.off('ht_ss_quotes:line_nums:reset', this.resetGroupLineNumbers, this);
                }

                if (ctx) {
                    ctx.off('ht_ss_quotes:show_line_nums:changed', this.onShowLineNumsChanged, this);
                }
            ...
            onShowLineNumsChanged: function(showLineNums, doRender) {
                var changed = false;
                var isBundle = this.model.module === 'HT_SS_ProductBundles' && this.collection.length;
            ...
            resetGroupLineNumbers: function(groupId, collection) {
                ...
                _.each(collection.models, _.bind(function(groupLineNumObj, model) {
                    if (model.module === 'HT_Sales_Service_Products') {
