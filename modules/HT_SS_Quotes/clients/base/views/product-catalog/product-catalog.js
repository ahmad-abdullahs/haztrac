 ...
 */
/**
 * @class View.Views.Base.HT_SS_Quotes.ProductCatalogView
...
({
    ...
    initialize: function(options) {
        ...
        this.searchText = app.lang.get('LBL_SEARCH_CATALOG_PLACEHOLDER', 'HT_SS_Quotes');
    ...
    loadData: function(options) {
        ...
        url = 'HT_Sales_Service_Catalog/tree';
    ...
    /**
     * Handles the HT_Sales_Service_Catalog/tree endpoint response
    ...
    _createPhaser: function() {
        ...
        var manifest = {
            atlasJSONHash: [
                {
                    id: 'prodCatTS',
                    imagePath: 'modules/HT_SS_Quotes/clients/base/views/product-catalog/product-catalog-ss.png',
                    dataPath: 'modules/HT_SS_Quotes/clients/base/views/product-catalog/product-catalog-ss.json'
                }
            ]
        };
    ...
    _fetchMoreRecords: function(id, offset, isShowMore, callback) {
        var callbacks;
        var method = 'create';
        var url = app.api.buildURL('HT_Sales_Service_Catalog/tree', method);
        var payload = {};
    ...
    _fetchProductTemplate: function(id, callbacks) {
        var url = app.api.buildURL('HT_Sales_Service_Catalog/' + id, 'read');
    ...
    _sendItemToQuote: function(data) {
        ...
        data.ht_sales_service_catalog_id = data.id;
        data.ht_sales_service_catalog_name = data.name;
    ...
    _openItemInDrawer: function(data) {
        var model = app.data.createBean('HT_Sales_Service_Catalog', data);
        app.drawer.open({
