 ...
 */
/**
 * @class View.Views.Base.HT_SS_Quotes.QuoteDataGrandTotalsHeaderView
...
({
    ...
    _onCreateQLIBtnClicked: function(evt) {
        this.context.trigger('ht_ss_quotes:defaultGroup:create', 'qli');
    },
    ...
    _onCreateCommentBtnClicked: function(evt) {
        this.context.trigger('ht_ss_quotes:defaultGroup:create', 'note');
    },
