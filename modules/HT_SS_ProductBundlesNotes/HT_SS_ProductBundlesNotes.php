 ...
 */
require_once('modules/HT_SS_ProductBundlesNotes/HT_SS_ProductBundlesNotes_sugar.php');
class HT_SS_ProductBundlesNotes extends HT_SS_ProductBundlesNotes_sugar {
     ...
     */
    public function set_ht_product_bundle_product_notes_relationship($bundle_id, $product_id, $note_id = '', $note_index)
    {
        if (empty($note_id)) {
            $note_id = $this->id;
        }
     ...
     * @param string $bundle_id
     */
    public function clear_ht_product_bundle_product_notes_relationship($bundle_id)
    {
