...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Template Λίστα',
  'LBL_MODULE_NAME' => 'Template',
  'LBL_MODULE_TITLE' => 'Template',
  'LBL_MODULE_NAME_SINGULAR' => 'Template',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου Template',
  'LNK_NEW_RECORD' => 'Δημιουργία Template',
  'LNK_LIST' => 'Προβολή Template',
  'LNK_IMPORT_CONTRACTS_TEMPLATE' => 'Import Template',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Template',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
  'LBL_CONTRACTS_TEMPLATE_SUBPANEL_TITLE' => 'Template',
  'LBL_NEW_FORM_TITLE' => 'Νέα Template',
  'LNK_IMPORT_VCARD' => 'Import Template vCard',
  'LBL_IMPORT' => 'Import Template',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new Template record by importing a vCard from your file system.',
);