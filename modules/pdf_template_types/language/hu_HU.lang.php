...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'PDF Template Types Lista',
  'LBL_MODULE_NAME' => 'PDF Template Types',
  'LBL_MODULE_TITLE' => 'PDF Template Types',
  'LBL_MODULE_NAME_SINGULAR' => 'PDF Template Type',
  'LBL_HOMEPAGE_TITLE' => 'Saját PDF Template Types',
  'LNK_NEW_RECORD' => 'Új létrehozása PDF Template Type',
  'LNK_LIST' => 'Megtekintés PDF Template Types',
  'LNK_IMPORT_PDF_TEMPLATE_TYPES' => 'Import PDF Template Types',
  'LBL_SEARCH_FORM_TITLE' => 'Keresés PDF Template Type',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Előzmények megtekintése',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Tevékenységek',
  'LBL_PDF_TEMPLATE_TYPES_SUBPANEL_TITLE' => 'PDF Template Types',
  'LBL_NEW_FORM_TITLE' => 'Új PDF Template Type',
  'LNK_IMPORT_VCARD' => 'Import PDF Template Type vCard',
  'LBL_IMPORT' => 'Import PDF Template Types',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new PDF Template Type record by importing a vCard from your file system.',
  'LBL_KEY_FIELD' => 'Key',
  'LBL_VALUE_FIELD' => 'Value',
