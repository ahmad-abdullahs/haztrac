 ...
 * PLACE ANY CUSTOMIZATIONS IN HRM_Employee_Info
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class HRM_Employee_Info_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'HRM_Employee_Info';
    public $object_name = 'HRM_Employee_Info';
    public $table_name = 'hrm_employee_info';
