...
$dictionary['HT_Sales_Service_Catalog'] = array(
    ...
    'fields' => array(
        ...
        'category_link' => array(
            'name' => 'category_link',
            'type' => 'link',
            'relationship' => 'ht_sales_service_catalog_product_categories',
        ...
        'type_link' => array(
            'name' => 'type_link',
            'type' => 'link',
            'relationship' => 'ht_sales_service_catalog_product_types',
        ...
        'manufacturer_link' => array(
            ...
            'type' => 'link',
            'relationship' => 'ht_sales_service_catalog_manufacturers',
    ...
    'relationships' => array(
        'ht_sales_service_catalog_product_categories' => array(
            'lhs_module' => 'ProductCategories',
            'lhs_table' => 'product_categories',
            'lhs_key' => 'id',
            'rhs_module' => 'HT_Sales_Service_Catalog',
            'rhs_table' => 'ht_sales_service_catalog',
            'rhs_key' => 'category_id',
            'relationship_type' => 'one-to-many'
        ),
        'ht_sales_service_catalog_product_types' => array(
        ...
        'ht_sales_service_catalog_manufacturers' => array(
    ...
    'acls' => array('SugarACLDeveloperOrAdmin' => array('aclModule' => 'HT_Sales_Service_Products', 'allowUserRead' => true)),
    'indices' => array (
        array('name' => 'idx_ss_catalog_status', 'type' => 'index', 'fields' => array('status')),
        array('name' => 'idx_ss_catalog_qty_in_stock', 'type' => 'index', 'fields' => array('qty_in_stock')),
        array('name' => 'idx_ss_catalog_category', 'type' => 'index', 'fields' => array('category_id')),
    ),
);
