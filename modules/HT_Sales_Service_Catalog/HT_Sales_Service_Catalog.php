 ...
 */
require_once('modules/HT_Sales_Service_Catalog/HT_Sales_Service_Catalog_sugar.php');
class HT_Sales_Service_Catalog extends HT_Sales_Service_Catalog_sugar {
	var $id;
	var $deleted;
	var $date_entered;
	var $date_modified;
	...
	function fill_in_additional_detail_fields() {
		...
		global $locale;
		global $sugar_config;
		// this is for ht_ss_quotes quicksearching a product. json_server does not make app_list_strings available
