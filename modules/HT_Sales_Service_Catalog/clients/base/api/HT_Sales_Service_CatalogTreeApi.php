...
class HT_Sales_Service_CatalogTreeApi extends SugarApi
{
    ...
    public function registerApiRest()
    {
        return array(
            'tree' => array(
                'reqType' => 'GET',
                'path' => array('HT_Sales_Service_Catalog', 'tree',),
                ...
                'longHelp' => 'modules/HT_Sales_Service_Catalog/clients/base/api/help/tree.html',
            ),
            'filterTree' => array(
                'reqType' => 'POST',
                'path' => array('HT_Sales_Service_Catalog', 'tree',),
    ...
    protected function getTreeData($union1Filter, $union2Filter, $filter1, $filter2)
    {
        $q = "select id, name, 'category' as type from product_categories " .
                "where deleted = 0 " .
                    $union1Filter .
            "union all " .
            "select id, name, 'product' as type from ht_sales_service_catalog " .
                "where deleted = 0 " .
                    $union2Filter .
            "order by type, name";
